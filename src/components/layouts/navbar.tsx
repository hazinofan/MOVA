    ...
    <>
        ...
        <div className="mx-auto h-full px-2 sm:px-3 flex items-center justify-center relative overflow-hidden">
          {ADS.map((ad, i) => (
            <Link
              key={i}
              href={ad.href || "#"}
              className={`absolute text-center px-4 transition-opacity duration-500 ease-in-out ${
      ...
      >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <nav className="hidden md:flex items-center gap-4 lg:gap-6">
                  ...
                  if (item.label === "SEARCH") {
                    return (
                      <button
                        ...
                        className={`${linkColor} transition-colors text-xs lg:text-[14px] font-druk tracking-[0.12em] hover:opacity-80 ${
                          showSearch ? "underline underline-offset-2" : ""
                        }`}
                      >
                        {item.label}
                      </button>
                ...
                <button
                  type="button"
                  onClick={() => setIsCartOpen(true)} // <-- CART OPEN
            ...
            <div className="mx-auto px-4 md:px-16 pb-3">
              ...
              >
                <input
                  ...
                  className={`flex-1 bg-transparent text-xl outline-none text-sm px-1 py-1 ${
                    isHome
                ...
                <button
                  type="submit"
                  className={`text-xs font-druk tracking-[0.16em] px-3 py-1 rounded-full flex items-center justify-center transition-colors ${
                    isHome
        ...
        >
          ...
          />
          <div
            className={`absolute left-0 top-0 h-full w-[80%] max-w-xs bg-black text-white transform transition-transform duration-300 ${
            ...
            <div className="p-4 space-y-2 bg-black h-screen">
              ...
              <div className="pt-4 border-t border-white/10 mt-2">
                <button
                  ...
                  onClick={() => {
                    setMenuOpen(false);
                    setIsCartOpen(true); // <-- CART OPEN FROM MOBILE MENU
                  }}
      ...
      >
        ...
        {/* drawer */}
        <div
          className={`absolute left-0 top-0 h-full w-[90%] max-w-md bg-white text-black shadow-2xl transform transition-transform duration-300 ${
            isCartOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          <div className="flex items-center justify-between px-4 h-14 border-b border-neutral-200">
            <h2 className="text-sm font-druk tracking-[0.16em]">
              YOUR CART
            </h2>
            <button
              onClick={() => setIsCartOpen(false)}
